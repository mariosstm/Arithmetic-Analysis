...
double f1(double x1 ,double x2 ,double x3 ,double k){
	return pow(x1,3.0)+4.0*x1*pow(x2,2.0)+3.0*pow(x3,3.0)-10.0+2.0*(1.0-k/N);
}

double f2(double x1 ,double x2 ,double x3 ,double k){
	return pow(x1,2.0)+5.0*pow(x1,2.0)*pow(x2,2.0)-3.0*(x3,2.0)+5.0-8.0*(1.0-k/N);
}

double f3(double x1 ,double x2 ,double x3 , double k){
	return pow(x1,4.0)+5.0*x1*x2+2.0*x3-2.0-6.0*(1.0-k/N);
}
